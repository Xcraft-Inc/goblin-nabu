...
const _retrieveMessageTranslations = watt(function* (quest, message, wrapper) {
...
const packMessages = function* (quest, desktopId, force, $appName, $appId) {
...
const unpackMessages = function* (quest, desktopId, mandate) {
  ...
  try {
    const content = JSON.parse(fse.readFileSync(translationsPath));
