...
const _trySetLocales = watt(function*(quest, locales, desktopId, next) {
...
const unpackMessages = function*(quest, desktopId, next) {
  ...
  try {
    ...
    yield _trySetLocales(quest, content.locales, desktopId, next);
