...
const extractMessages = function* (
  ...
  */
  ...
  for (const msgId of messagesToDelete) {
    promises.push(
      _deleteMessage(quest, messagesMap, msgId, desktopId, appName, $msg)
    );
  }
  ...
  for (const msgId of messagesToAdd) {
    promises.push(addMessage(quest, messagesMap[msgId], desktopId, $msg));
  }
  ...
  for (let msgId of messagesToPatch) {
    promises.push(
      patchMessage(quest, messagesMap[msgId], desktopId, appName, $msg)
    );
  }
