...
module.exports = function() {
  ...
  function isBaseT(path, state) {
    ...
    return isImported(callee, T_SOURCE_NAME, T_COMPONENT_NAMES);
  }
  ...
  function isWidgetT(path, state) {
    ...
    if (callee.isMemberExpression()) {
      ...
      if (
        isImported(obj, WIDGET_SOURCE_NAME, WIDGET_COMPONENT_NAMES) &&
  ...
  function extract(path, state) {
    const isT = isBaseT(path, state) || isWidgetT(path, state);
