...
const nabuConfig = require('xcraft-core-etc')().load(`goblin-${goblinName}`);
...
Goblin.registerQuest(goblinName, 'init-desktop', function*(
  ...
  yield loadToolbar(quest, desktopId, showToolbar, storageAvailable, next);
